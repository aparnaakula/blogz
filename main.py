...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://blogz:appuravi@12@localhost:8889/blogz'
...
def display_blog():   
    ...
    if (entry_id):
        ...
        return render_template('newblog.html',title="Build a Blog",post=post, posts=posts,pub_date=post.pub_date, user_id=post.owner_id)
    if (user_id):
